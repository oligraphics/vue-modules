...
export type IRouterModule<
  TRouteRecord = unknown,
  TNavigationGuard = unknown,
  TNavigationHookAfter = unknown,
> = {
  routes?: TRouteRecord[];
...
export type IRouterModuleCompiler<
  TRouteRecord = unknown,
  TNavigationGuard = unknown,
  TNavigationHookAfter = unknown,
> = IModuleCompiler & {
  props: {
    compiledRoutes: IModuleValueCompiler<
      IRouterModule<TRouteRecord, TNavigationGuard, TNavigationHookAfter>,
      TRouteRecord
    >;
    compiledBeforeEach: IModuleValueCompiler<
      IRouterModule<TRouteRecord, TNavigationGuard, TNavigationHookAfter>,
      TNavigationGuard
    >;
    compiledAfterEach: IModuleValueCompiler<
      IRouterModule<TRouteRecord, TNavigationGuard, TNavigationHookAfter>,
...
export type ICompiledRouterModule<
  TRouteRecord = unknown,
  TNavigationGuard = unknown,
  TNavigationHookAfter = unknown,
> = IRouterModule<TRouteRecord, TNavigationGuard, TNavigationHookAfter> & {
