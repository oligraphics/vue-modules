...
export type AsyncColdStartHandler<TApp = unknown> = (
  rootModule: IModule,
  app: TApp,
  onProgress?: ProgressHandler,
) => Promise<void> | void
export type AsyncHotStartHandler = (
  rootModule: IModule,
  onProgress?: ProgressHandler,
) => Promise<void> | void
...
export type IStartupModuleCompiler<TApp = unknown> = IModuleCompiler & {
  props: {
    compiledPerformColdStart: IModuleValueCompiler<
      IStartupModule<TApp>,
      AsyncColdStartHandler<TApp>,
      AsyncColdStartHandler<TApp>
    >
    compiledPerformHotStart: IModuleValueCompiler<
      IStartupModule<TApp>,
      AsyncHotStartHandler,
      AsyncHotStartHandler
    >
    compiledPerformShutdown: IModuleValueCompiler<
      IStartupModule<TApp>,
      ShutdownHandler,
      ShutdownHandler
    >
